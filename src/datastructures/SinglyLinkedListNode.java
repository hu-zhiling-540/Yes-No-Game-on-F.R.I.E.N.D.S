...
public class SinglyLinkedListNode<T>	{
	...
	public T data;	//A piece of data is stored as an instance variable of the node.
	public SinglyLinkedListNode<T> next;	//references to a node stored in an instance variable of the node
